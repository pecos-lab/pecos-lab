...
```
📣  마케터 출신 개발자    —  릴스로 실제 매출을 만들어본 경험
💡  사용자 가치 우선      —  쓸모 있는 기능 하나가 완성될 때, 본능적으로 기쁩니다
🚀  Ship fast             —  완벽보다 빠른 릴리즈가 더 많은 걸 알려줍니다
🔧  풀스택 지향           —  스택이 달라도 괜찮습니다, 문제 해결이 먼저입니다
🤖  AI-Native 개발        —  아이디어에서 프로토타입까지 빠르게
🎯  지금                  —  홍보할 내 제품을 직접 만드는 중
```
